            ...
            {alignments.map((alignment) => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  selectedAlignment === alignment && styles.selectedAlignmentButton
                ]}
              ...
              >
                <MaterialIcons 
                  ...
                  size={20} 
                  color={selectedAlignment === alignment ? 'white' : '#666'} 
                />
              </TouchableOpacity>
            ))}
          </ScrollView>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            {textAnimations.map((animation) => (
              <TouchableOpacity
                ...
                onPress={() => onAddAnimation?.(animation)}
              >
                <MaterialIcons name="animation" size={16} color="white" />
                <Text style={styles.animationText}>{animation}</Text>
              </TouchableOpacity>
            ))}
          </ScrollView>
        </View>
